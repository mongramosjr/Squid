...
import app.sthenoteuthis.mobile.databinding.FragmentMultiFactorSignInBinding
import java.util.concurrent.TimeUnit

class MultiFactorSignInFragment : ProgressFragment() {
    private var _binding: FragmentMultiFactorSignInBinding? = null
    private val binding: FragmentMultiFactorSignInBinding get() = _binding!!
    ...
    private fun onClickFinishSignIn() {
        ...
        multiFactorResolver
            ...
            .addOnSuccessListener {
                Navigation.findNavController(binding.root).navigate(R.id.action_multiFactorSignInFragment_to_myselfFragment)
            }
